    ...
    <>
      ...
      <div className="flex items-center gap-4">
        ...
        <div ref={dropdownRef} className="relative">
          ...
          >
            <Bell size={18} className="text-[var(--text-secondary)]" />
            <span className="absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full bg-red-500 text-white text-[10px] flex items-center justify-center font-bold" aria-hidden="true">
              3
            </span>
          </button>
